...
abstract class GogolookDatabase : RoomDatabase() {

    /**
     * Connects the database to the DAO.
     */
    abstract val gogolookDatabaseDao: GogolookDatabaseDao
    ...
    companion object {
         ...
         */
        @Volatile
        private var INSTANCE: GogolookDatabase? = null
         ...
         */
        fun getInstance(context: Context): GogolookDatabase {
